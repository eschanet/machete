...
def run():
    ...
    parser.add_argument('-output_path', help='path to plots', default='v2-0-4')
    ...
    parser.add_argument('--MTnMinusOne', help='Remove cut on mT for N-1 plots', action='store_true')
    ...
    for region, cut in regions.iteritems():
        ...
        if args.MTnMinusOne:
            cut = cut.replace("mt>100. && ","").replace("mt>520 && ","").replace("mt>150 && mt<520 &&","").replace("mt>225. && ","")
            setMoreInfoLabel += " no mT cut"
        ...
        if args.signal or args.significance:
            if args.analysis == "strong1L" or args.analysis == "alt_strong-1L":
                signalpoints = [
                    ("2J","GG_oneStep_1000_900_800","GG_oneStep_1000_900_800"),
                    ...
                    ("2J","SS_oneStep_700_650_600","SS_oneStep_700_650_600"),
                    # ("4Jlowx","GG_oneStep_2000_960_60","GG_oneStep_2000_960_60"),
                    # ("4Jlowx","GG_oneStep_2000_660_60","GG_oneStep_2000_660_60"),
                    # ("4Jlowx","GG_oneStep_2000_360_60","GG_oneStep_2000_360_60"),
                    ("4Jlowx","GG_oneStep_1600_360_60","GG_oneStep_1600_360_60"),
                    # ("4Jlowx","SS_oneStep_1400_260_60","SS_oneStep_1400_260_60"),
                    ("4Jlowx","SS_oneStep_1200_260_60","SS_oneStep_1200_260_60"),
       ...
       #        nf.getAndSetNFs(cut, tp, 'presel')
        ...
        for varname, dict in me.varsDict.iteritems():
            ...
            if args.MTnMinusOne and varname is 'mt':
                dict["xmin"] = 50
                if '2J' in region:
                    dict["xmax"] = 410
                    dict["nbins"] = 18
            ...
            elif args.MTnMinusOne and not varname is 'mt':
                continue
