...
def run():
    ...
    parser.add_argument('-input_mc', help='input MC trees', default='/project/etp4/eschanet/trees/v2-0/allTrees_v2_0_2_bkg_NoSys.root')
    parser.add_argument('-input_data', help='input MC trees', default='/project/etp4/eschanet/trees/v2-0/allTrees_v2_0_data.root')
    ...
    for region, cut in regions.iteritems():
        ...
        for treename in trees:
            ...
            if treename == "wjets":
                ...
                evtWeight = "(1)"
                tp.addProcessTree(me.names[treename], args.input_mc, treename+"_NoSys",  scale=nf, cut=evtWeight,style="background", color=me.colors[treename])
            else:
                tp.addProcessTree(me.names[treename], args.input_mc, treename+"_NoSys",  scale=nf, style="background", color=me.colors[treename])
